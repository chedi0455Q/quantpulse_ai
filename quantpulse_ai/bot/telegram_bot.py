...
try:
    ...
    class DummyMT5Executor:
        def __init__(self):
            self.is_connected = False
        def execute_auto_trade(self, eval_data):
            return {"success": False, "message": "MT5 non disponible sur l'environnement Cloud."}

    MT5Executor = DummyMT5Executor
